...
const RoomSearchPanel = ({ rooms = [] }) => {
  ...
  return (
    ...
    // </div>
    <div className="flex flex-col lg:flex-row w-full h-screen bg-neutral-50/50 dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100 overflow-hidden transition-colors duration-200">

  {/* ================= SIDEBAR ================= */}
  <aside className="w-full lg:w-80 bg-olive-200 dark:bg-neutral-900 border-b lg:border-b-0 lg:border-r border-neutral-200 dark:border-neutral-800 lg:sticky top-0 h-auto lg:h-full max-h-[45vh] lg:max-h-none overflow-y-auto shrink-0 z-10 shadow-sm transition-colors duration-200">
    ...
    <div className="p-4 sm:p-6 space-y-5 sm:space-y-6">
      ...
      <div className="space-y-1.5">
        ...
        <input
          ...
          onChange={(e) => setSearchText(e.target.value)}
          placeholder="Search by name..."
          className="w-full bg-white dark:bg-neutral-950 text-neutral-800 dark:text-neutral-200 placeholder-neutral-400 dark:placeholder-neutral-500 text-sm border border-neutral-300 dark:border-neutral-800 rounded-xl px-3.5 py-2.5 shadow-sm focus:outline-none focus:border-[#4F5A2A] focus:ring-1 focus:ring-[#4F5A2A] transition-all"
        />
      </div>
          ...
          {allAmenities.map((amenity) => {
            ...
            return (
              <button
                ...
                type="button"
                onClick={() => toggleAmenity(amenity)}
                className={`inline-flex items-center text-xs font-medium px-3 py-1.5 rounded-full transition-all duration-200 ${
                  active
                    ? "bg-[#4F5A2A] text-white shadow-md border border-[#4F5A2A]"
                    : "bg-white dark:bg-neutral-950 text-neutral-700 dark:text-neutral-300 border border-neutral-300 dark:border-neutral-800 hover:bg-neutral-50 dark:hover:bg-neutral-900"
                }`}
              >
                {amenity}
              </button>
      ...
      <button
        ...
        className="w-full text-center text-sm font-semibold text-neutral-600 dark:text-neutral-400 border border-neutral-300 dark:border-neutral-800 hover:text-neutral-900 dark:hover:text-neutral-200 hover:bg-neutral-50 dark:hover:bg-neutral-900 transition-all py-2.5 rounded-xl"
      >
        Clear filters
      </button>
  ...
  <main className="flex-1 overflow-y-auto bg-neutral-50 dark:bg-neutral-950 transition-colors duration-200">
    ...
    <div className="max-w-7xl mx-auto py-6 sm:py-8 px-4 sm:px-6 lg:px-8">
      ...
      {filteredRooms.length > 0 ? (
        ...
        <div className="w-full max-w-xl mx-auto mt-10 sm:mt-12 rounded-2xl border border-dashed border-neutral-300 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-8 sm:p-12 text-center shadow-sm">
          <div className="mx-auto flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full bg-neutral-100 dark:bg-neutral-950">
            <svg
              className="h-5 w-5 sm:h-6 sm:w-6 text-neutral-400 dark:text-neutral-500"
              fill="none"
              viewBox="0 0 24 24"
              strokeWidth="1.5"
              stroke="currentColor"
          ...
          <h3 className="mt-4 text-sm sm:text-base font-semibold text-neutral-900 dark:text-neutral-100">
